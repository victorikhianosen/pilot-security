            ...
            <div class="pagination-container">
                ...
                <div class="">
                    ...
                    <span class="font-semibold">
                        {{ ($bondPrices->currentPage() - 1) * $bondPrices->perPage() + 1 }}
                    </span>
                    to
                    <span class="font-semibold">
                        {{ ($bondPrices->currentPage() - 1) * $bondPrices->perPage() + $bondPrices->count() }}
                    </span>
                    of
                    <span class="font-semibold">
                        {{ $bondPrices->total() }}
                ...
                <div class="pagination-buttons flex space-x-2">
                    @if ($bondPrices->onFirstPage())
                        <span class="disabled">Previous</span>
                    @else
                        <a href="{{ $bondPrices->previousPageUrl() }}">Previous</a>
                    @endif

                    @if ($bondPrices->hasMorePages())
                        <a href="{{ $bondPrices->nextPageUrl() }}">Next</a>
                    @else
