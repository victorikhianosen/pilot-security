...
@section('main_content')
    ...
    <section class="banner-section style-two">
      <div class="banner-carousel owl-theme owl-carousel owl-dots-none">
        <div class="slide-item">
          <div
            class="image-layer"
            style="background-image: url(assets/images/banner/banner-16.jpg)"
          ></div>
          <div class="auto-container">
            <div class="content-box">
              <h5>world class stockbrokers</h5>
              <h1>Beyond Broking <br />We Build Wealth</h1>
              <p>
                We’re more than brokers, we’re your long-term financial
                partners. From retail clients to corporates, <br />PSL is the
                broker of choice for those who value integrity, insight, and
                results.
              </p>
              <div class="btn-box">
                <a href="contact.html" class="theme-btn style-two"
                  ><i class="fas fa-atom"></i>Get started</a
                >
                <!-- <a href="index-6.html" class="user-btn-two"
                  ><i class="far fa-user"></i>Find an Agent</a
                > -->
              </div>
            </div>
          </div>
        ...
        <div class="slide-item">
          <div
            class="image-layer"
            style="background-image: url(assets/images/banner/banner-15.jpg)"
          ></div>
          <div class="auto-container">
            <div class="content-box centred">
              <h1>Legacy of Trust, <br />Engineered for Tomorrow</h1>
              <p>
                Born from the restructuring of Pilot Securities Limited, PSL has
                become a leading force in Nigeria’s capital market
                <br />delivering expert stockbroking, investment advisory, and
        ...
        <div class="slide-item">
          ...
          <div class="auto-container">
            <div class="content-box">
              <h5>Spendid Track record</h5>
              <h1>Over ₦750 Million in <br />Paid-up Capital</h1>
              <p>
                We bring together financial strength, top-tier professionals,
                and
                <br />cutting-edge technology to serve individuals and
                institutions with precision and speed.
              </p>
              <div class="btn-box">
                <a href="contact.html" class="theme-btn style-two mar-0"
                  ><i class="fas fa-atom"></i>Get started</a
                >
              </div>
            </div>
        ...
        <div class="row clearfix">
            ...
            <div id="content_block_three">
              <div class="content-box">
                <div class="sec-title style-two">
                  <h5>About Pilot Securities</h5>
                  <h2>Our Background</h2>
                </div>
                <div class="text">
                  <p>
                    Pilot Securities Limited (herein after referred to as PSL or
                    “the Company”), was incorporated on 16<sup>th</sup> January
                    2003. The Company took over the Capital Market functions of
                    Pilot Finance Limited in October 2004. Pilot Finance Limited
                    was licensed in 1998 by both the Securities & Exchange
                    Commission and The Nigerian Stock Exchange as Broker/Dealer,
                    Investment Adviser and a trading license holder
                    respectively.
                  </p>
                </div>
                <div class="inner-box">
                  <div class="row clearfix">
                    <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                      <div class="single-item">
                        ...
                        <p>
                          To be a leading stockbroking firm in facilitating
                          wealth creation through professionalism and integrity
                          backed by efficient service delivery.
                        </p>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                      <div class="single-item">
                        ...
                        <p>
                          To become a foremost stock broking firm in the
                          provision of highest standard of financial service
                          delivery, facilitating wealth creation for our
                          stakeholders.
                        </p>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                      <div class="single-item">
                        <div class="icon-box">
                          <i class="flaticon-safe-5"></i>
                        </div>
                        <h5><a href="#">Core Value</a></h5>
                        <p>
                          our success is built on a strong foundation of values
                          that guide every interaction, decision, and service we
                          deliver.
                        </p>
                      </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 single-column">
                      <div class="single-item">
                        ...
                        <p>
                          Conseqrue dolorn repreh deris velit excepteur duis
                          aute.
                        </p> -->
                      </div>
                    </div>
          ...
          <div class="col-lg-5 col-md-12 col-sm-12 image-column">
            <div id="image_block_two">
              <div class="image-box">
                <figure class="image">
                  <img src="assets/images/resource/about psl.png" alt="" />
                </figure>
                <div class="content-box">
                  <i class="fas fa-headphones-alt"></i>
                  <h4>Invest With Us Today</h4>
                  <h5>
                    Any questions? Call
                    <a href="tel:01005200369">0816 227 4510</a>
                  </h5>
                </div>
              </div>
            </div>
        ...
        <div class="row clearfix">
          <div class="col-lg-3 col-md-6 col-sm-12 single-column">
            <div class="single-item">
              ...
              <h3>Legal & Regulatory Integrity</h3>
            </div>
          </div>
          <div class="col-lg-3 col-md-6 col-sm-12 single-column">
            <div class="single-item">
    ...
    <section class="service-style-two bg-color-2">
      ...
      <div class="auto-container">
        <div class="sec-title light centred">
          <h5>our PRODUCTS</h5>
          <h2>Areas We Got<br />You Fully Covered</h2>
          <p>
            Tracking your porfolio, buying stock & selling stocks have never
            been easier!
            <br />
            Welcome to Pilot Securities e-Business Suite. Want to get on board?
          </p>
        </div>
        <div class="row clearfix">
          <div class="col-lg-4 col-md-6 col-sm-12 service-block">
            <div
              class="service-block-two wow fadeInUp"
              data-wow-delay="00ms"
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 service-block">
            ...
            >
              <div class="inner-box">
                ...
                <p>
                  provide expert investment advice tailored to your goals. Our
                  personalized strategies help you make smart, confident
                  decisions to grow and protect your wealth.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12 service-block">
            ...
            >
              <div class="inner-box">
                ...
                <p>
                  We expertly handle your investments, balancing risk and reward
                  to maximize your returns. Sit back while our professionals
                  create and manage a personalized portfolio just for you.
                </p>
              </div>
            </div>
          </div>
                  ...
                  >
                    ...
                    <g id="SVGRepo_iconCarrier">
                      <g>
                        <path
                          fill="#808184"
                          d="M38.5,11H30V1.5C30,0.673,29.327,0,28.5,0h-27C0.673,0,0,0.673,0,1.5v19C0,21.327,0.673,22,1.5,22H9v8.5 c0,0.827,0.673,1.5,1.5,1.5h28c0.827,0,1.5-0.673,1.5-1.5v-18C40,11.673,39.327,11,38.5,11z M1,20.5v-19C1,1.224,1.225,1,1.5,1h27 C28.775,1,29,1.224,29,1.5v19c0,0.276-0.225,0.5-0.5,0.5h-27C1.225,21,1,20.776,1,20.5z M39,30.5c0,0.276-0.225,0.5-0.5,0.5h-28 c-0.275,0-0.5-0.224-0.5-0.5V22h18.5c0.827,0,1.5-0.673,1.5-1.5V12h8.5c0.275,0,0.5,0.224,0.5,0.5V30.5z"
                        ></path>
                        <path
                          fill="#808184"
                          d="M7.36,5h-3c-0.276,0-0.5,0.224-0.5,0.5S4.084,6,4.36,6h3c0.276,0,0.5-0.224,0.5-0.5S7.637,5,7.36,5z"
                        ></path>
                        <path
                          fill="#808184"
                          d="M7.36,16h-3c-0.276,0-0.5,0.224-0.5,0.5S4.084,17,4.36,17h3c0.276,0,0.5-0.224,0.5-0.5S7.637,16,7.36,16z"
                        ></path>
                        <path
                          fill="#808184"
                          d="M22.36,6h3c0.276,0,0.5-0.224,0.5-0.5S25.637,5,25.36,5h-3c-0.276,0-0.5,0.224-0.5,0.5S22.084,6,22.36,6z"
                        ></path>
                        <path
                          fill="#808184"
                          d="M22.36,17h3c0.276,0,0.5-0.224,0.5-0.5s-0.224-0.5-0.5-0.5h-3c-0.276,0-0.5,0.224-0.5,0.5 S22.084,17,22.36,17z"
                        ></path>
                        <path
                          fill="#808184"
                          d="M15,15.5c2.481,0,4.5-2.019,4.5-4.5S17.481,6.5,15,6.5s-4.5,2.019-4.5,4.5S12.519,15.5,15,15.5z M15,7.5 c1.93,0,3.5,1.57,3.5,3.5s-1.57,3.5-3.5,3.5s-3.5-1.57-3.5-3.5S13.07,7.5,15,7.5z"
                        ></path>
                      </g>
                    </g>
                  </svg>
                </div>
                <h4><a href="#">Bond Trading</a></h4>
                <p>
                  We specialize in buying and selling bonds to help you earn
                  steady income and diversify your investments.
                </p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-12 service-block">
            ...
            >
              <div class="inner-box">
                ...
                <h4><a href="index-2.html">Global Research</a></h4>
                <p>
                  in-depth market analysis and expert reports from around the
                  world. Stay ahead with the latest trends, data, and insights
          ...
          <div class="col-lg-4 col-md-6 col-sm-12 service-block">
            ...
            >
              <div class="inner-box">
                ...
                <h4>
                  <a href="#">Certificate & Dividend Recovery</a>
                </h4>
                <p>
                  We help you reclaim lost certificates and unpaid dividends
                  quickly and securely. Trust us to recover your assets and
                  maximize your investment returns with ease..
                </p>
              </div>
            </div>
          </div>
    ...
    <section class="protect-form centred">
      <div class="auto-container">
        <div class="inner-box">
          ...
          <h3>Not sure which investment, suits you the best? Contact Us</h3>
          <form action="#" method="post" class="zip-form">
            <div class="form-group clearfix">
              <input
                ...
                required=""
              />
              <button class="theme-btn style-two" type="submit">
                <i class="far fa-user"></i>Send Email
              </button>
            </div>
          </form>
        </div>
                ...
                <div class="tabs-box">
                  <div class="tab-btn-box">
                    <ul class="tab-btns tab-buttons clearfix">
                      ...
                      <li class="tab-btn" data-tab="#tab-3">Core Value</li>
                    </ul>
                  </div>
                  <div class="tabs-content">
                    <div class="tab active-tab" id="tab-1">
                      <div class="content-inner">
                        <p>
                          To be a leading stockbroking firm in facilitating
                          wealth creation through professionalism and integrity
                          backed by efficient service delivery. To be a company
                          with global outlook, employing highly skilled and
                          motivated professionals for efficient delivery of
                          excellent services which are designed for customer
                          satisfaction and creating wealth for national
                          development.
                        </p>
                    ...
                    <div class="tab" id="tab-2">
                      <div class="content-inner">
                        <p>
                          At Pilot Securities Limited, our vision is to become a
                          foremost stockbroking firm known for excellence,
                          innovation, and unwavering commitment to our clients’
                          financial growth. We are dedicated to setting the
                          benchmark in the capital market through:
                        </p>
                        <ul class="list-item clearfix">
                          <li>Unmatched Financial Service Delivery</li>
                          <li>Wealth Creation for Stakeholders</li>
                          <li>Leadership in the Stockbroking Industry</li>
                          <li>Empowerment Through Expertise</li>
                        </ul>
                      </div>
                    </div>
                    <div class="tab" id="tab-3">
                      <div class="content-inner">
                        <p>
                          At Pilot Securities Limited, our success is built on a
                          strong foundation of values that guide every
                          interaction, decision, and service we deliver. These
                          core principles define who we are and shape how we
                          serve our clients and stakeholders.
                        </p>
                        <ul class="list-item clearfix">
            ...
            <div id="video_block_one">
              <div class="video-inner">
                <figure class="image-box">
                  <img src="assets/images/resource/download (5).png" alt="" />
                </figure>
                <div class="video-btn">
                  <a
    ...
    <section class="team-section">
      <div class="auto-container">
        ...
        <div
          class="four-item-carousel owl-carousel owl-theme owl-nav-none owl-dot-style-one"
        >
          <div class="team-block-one">
            <div class="inner-box">
              <figure class="image-box">
                <img src="assets/images/team/Jonesdealer.png" alt="" />
              </figure>
              <div class="lower-content">
                <div class="content-box">
                  <h3><a href="#">Abiodun Jones</a></h3>
                  <span class="designation">Cheif Dealer/ Head of Operations</span>
                </div>
              </div>
            </div>
          </div>
          <div class="team-block-one">
            <div class="inner-box">
              <figure class="image-box">
                <img src="assets/images/team/Mrs Ireyomi.png" alt="" />
              </figure>
              <div class="lower-content">
                <div class="content-box">
                  <h3><a href="#">Kemi Ireyomi</a></h3>
                  <span class="designation">Cheif Risk Officer</span>
                </div>
              </div>
            </div>
          </div>
          <div class="team-block-one">
            <div class="inner-box">
              <figure class="image-box">
                <img src="assets/images/team/Shegun.jpg" alt="" />
              </figure>
              <div class="lower-content">
                <div class="content-box">
                  <h3><a href="#">Shegun Adetola</a></h3>
                  <span class="designation">ACS</span>
                </div>
              </div>
            </div>
          </div>
          <div class="team-block-one">
            <div class="inner-box">
              <figure class="image-box">
                <img src="assets/images/team/bimbsa.png" alt="" />
              </figure>
              <div class="lower-content">
                <div class="content-box">
                  <h3><a href="#">Abimbola Eyiolawi</a></h3>
                  <span class="designation">Chief Compliance Office</span>
                </div>
    </section>
      ...
      <div class="auto-container">
        <div class="inner-container clearfix">
          ...
          <div class="text pull-left">
            ...
            <h2>Not sure about the right investment for you?</h2>
            <h3>We have got some best investment plans and solutions</h3>
          </div>
          <div class="btn-box pull-right">
            <a href="index-2.html" class="theme-btn style-one">Contact Us</a>
          </div>
        </div>
      </div>
    </section>
    ...
    <section class="testimonial-style-two">
      <div class="auto-container">
        ...
        <div
          class="three-item-carousel owl-carousel owl-theme owl-nav-none owl-dot-style-one"
        >
          <div class="testimonial-content">
            <div class="inner-box">
              <div class="text">
                ...
                <p>
                   "I’ve seen my portfolio grow faster than I expected, and I finally feel confident about every trade. If you want a trustworthy partner in your investment journey, look no further!"
                </p>
              </div>
          ...
          <div class="testimonial-content">
            <div class="inner-box">
              <div class="text">
                <i class="fas fa-quote-right"></i>
                <p>
                 "Investing feels effortless and exciting! Their expert guidance and seamless platform turn stock trading into an experience, not a chore. I’m not just buying shares, I’m building a future with a team I trust."
                </p>
              </div>
              <div class="author-info">
                <figure class="image-box">
            ...
            <div id="content_block_five">
              <div class="content-box">
                <div class="sec-title light left">
                  <h5>talk to a Broker</h5>
                  <h2>Get Free Consultation</h2>
                  <p>
                    Ready to grow your wealth? Get expert advice at no cost,
                ...
                <ul class="info-list clearfix">
                  <li>
                    ...
                    <p>9 Younis Bashorun street, VI, Lagos state.</p>
                  </li>
                  <li>
                  ...
                  <li>
                    ...
                    <h4>Email Support</h4>
                    <p>
                      <a href="mailto:info@my-domain.com"
                        >info@pilotsecurities.com
                      </a>
                      /
                      <a href="mailto:support@info.com"
                        >client@pilotsecurities.com</a
                      >
                    </p>
                  </li>
                </ul>
                ...
                <div class="tabs-box">
                  <div class="tab-btn-box">
                    <ul class="tab-btns tab-buttons clearfix">
                      ...
                      <li class="tab-btn" data-tab="#tab-5">Stock</li>
                      <li class="tab-btn" data-tab="#tab-6">Sukuk</li>
                      <li class="tab-btn" data-tab="#tab-7">Equity</li>
                    </ul>
                  </div>
                  <div class="tabs-content">
                    <div class="tab active-tab" id="tab-4">
                      <div class="content-inner">
                        <p>
                          Select a product to start. Or call us at
                          <a href="tel:01005200369">0100-5200-369</a>
                        </p>
                          ...
                          <div class="form-group">
                            ...
                            <div class="select-box">
                              <select class="wide">
                                ...
                                <option value="5">Government papers</option>
                              </select>
                            </div>
                          </div>
    ...
    <section class="clients-section">
      <div class="auto-container">
        <div
          class="clients-carousel owl-carousel owl-theme owl-dots-none owl-nav-none"
        >
          <figure class="client-logo">
            <a href="index.html"
              ><img
                src="assets/images/clients/asset matrix transparent logo.png"
                alt=""
            /></a>
          </figure>
          <figure class="client-logo">
            <a href="index.html"
              ><img
                src="assets/images/clients/richgreen masters without rc.png"
                alt=""
            /></a>
          </figure>
          <figure class="client-logo">
            <a href="index.html"
              ><img src="assets/images/clients/Logo cashmatrix.png" alt=""
            /></a>
          </figure>
          <figure class="client-logo">
            <a href="index.html"
              ><img src="assets/images/clients/smstrix-02.png" alt=""
            /></a>
          </figure>
          <figure class="client-logo">
            <a href="index.html"
              ><img src="assets/images/clients/logo-2.png" alt=""
            /></a>
          </figure>
        </div>
      </div>
