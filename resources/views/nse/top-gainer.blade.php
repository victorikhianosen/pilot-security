...
@section('admin_content')
    <main class="flex-grow p-6">
        ...
        <div class="flex justify-between items-center mb-6">
            <h4 class="text-slate-900 dark:text-slate-200 text-lg font-medium">Top Gainer</h4>
            <div>
        ...
        <div id="default-modal" class="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-50 hidden"
            ...
            <div
                ...
                <form action="{{ route('admin.nse.togainer.store') }}" method="POST" enctype="multipart/form-data">
                    @csrf
